...
function LinkSettings(_ref) {
  ...
  var onChangeURL = (0, _element.useCallback)(function (value) {
    if (!value && onEmptyURL) {
      onEmptyURL();
    }
  ...
  var onChangeLabel = (0, _element.useCallback)(function (value) {
    setLabelInputValue(value);
  }, []);
  var onSetAttributes = (0, _element.useCallback)(function () {
    var newURL = (0, _url.prependHTTP)(urlInputValue);
  ...
  var onCloseSettingsSheet = (0, _element.useCallback)(function () {
    onSetAttributes();
  ...
  var onChangeOpenInNewTab = (0, _element.useCallback)(function (value) {
  ...
  var onChangeLinkRel = (0, _element.useCallback)(function (value) {
