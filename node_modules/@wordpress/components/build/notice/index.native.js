...
var Notice = function Notice(_ref) {
  ...
  var successTextStyles = (0, _compose.usePreferredColorSchemeStyle)(_style.default.successText, _style.default.successTextDark);
  var errorTextStyles = (0, _compose.usePreferredColorSchemeStyle)(_style.default.errorText, _style.default.errorTextDark);
  var textStyles = [status === 'success' && successTextStyles, status === 'error' && errorTextStyles];
