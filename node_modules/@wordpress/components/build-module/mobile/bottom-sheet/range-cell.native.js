...
var BottomSheetRangeCell = /*#__PURE__*/function (_Component) {
  ...
  function BottomSheetRangeCell(props) {
    ...
    _this.onSliderChange = _this.onSliderChange.bind(_assertThisInitialized(_this));
    _this.onTextInputChange = _this.onTextInputChange.bind(_assertThisInitialized(_this));
    _this.a11yIncrementValue = _this.a11yIncrementValue.bind(_assertThisInitialized(_this));
    _this.a11yDecrementValue = _this.a11yDecrementValue.bind(_assertThisInitialized(_this));
    _this.a11yUpdateValue = _this.a11yUpdateValue.bind(_assertThisInitialized(_this));
  ...
  _createClass(BottomSheetRangeCell, [{
    ...
    value: function a11yIncrementValue() {
      ...
      var newValue = toFixed(inputValue + step, decimalNum);
    ...
    value: function a11yDecrementValue() {
      ...
      var newValue = toFixed(sliderValue - step, decimalNum);
    ...
    value: function render() {
      ...
      return createElement(View, {
        ...
        testID: "Slider ".concat(cellProps.label),
        value: sliderValue,
