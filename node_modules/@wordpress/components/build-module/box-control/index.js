...
export default function BoxControl(_ref) {
  var idProp = _ref.id,
      ...
      units = _ref.units,
      sides = _ref.sides,
      _ref$resetValues = _ref.resetValues,
      resetValues = _ref$resetValues === void 0 ? DEFAULT_VALUES : _ref$resetValues;
  ...
  var hasOneSide = (sides === null || sides === void 0 ? void 0 : sides.length) === 1;
  ...
  var _useState3 = useState(!hasInitialValue || !isValuesMixed(inputValues) || hasOneSide),
  ...
  return createElement(Root, {
    ...
    "aria-label": label
  }, inputControlProps))), !hasOneSide && createElement(FlexItem, null, createElement(LinkedButton, {
