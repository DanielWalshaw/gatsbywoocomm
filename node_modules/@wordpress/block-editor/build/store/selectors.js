...
var __experimentalGetPatternsByBlockTypes = (0, _rememo.default)(function (state, blockNames) {
  var rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  if (!blockNames) return EMPTY_ARRAY;

  var patterns = __experimentalGetAllowedPatterns(state, rootClientId);

  var normalizedBlockNames = Array.isArray(blockNames) ? blockNames : [blockNames];
  return patterns.filter(function (pattern) {
    var _pattern$blockTypes, _pattern$blockTypes$s;

    return pattern === null || pattern === void 0 ? void 0 : (_pattern$blockTypes = pattern.blockTypes) === null || _pattern$blockTypes === void 0 ? void 0 : (_pattern$blockTypes$s = _pattern$blockTypes.some) === null || _pattern$blockTypes$s === void 0 ? void 0 : _pattern$blockTypes$s.call(_pattern$blockTypes, function (blockName) {
      return normalizedBlockNames.includes(blockName);
    });
  });
}, function (state, rootClientId) {
  return (0, _toConsumableArray2.default)(__experimentalGetAllowedPatterns.getDependants(state, rootClientId));
});
/**
...
var __experimentalGetPatternTransformItems = (0, _rememo.default)(function (state, blocks) {
  var rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  if (blocks.some(function (_ref15) {
    var clientId = _ref15.clientId,
        innerBlocks = _ref15.innerBlocks;
  ...
  var selectedBlockNames = Array.from(new Set(blocks.map(function (_ref16) {
  ...
  return (0, _toConsumableArray2.default)(__experimentalGetPatternsByBlockTypes.getDependants(state, rootClientId));
});
/**
...
function wasBlockJustInserted(state, clientId, source) {
  var lastBlockInserted = state.lastBlockInserted;
