...
var BlockSwitcherDropdownMenu = function BlockSwitcherDropdownMenu(_ref) {
  ...
  var isTemplate = blocks.length === 1 && (0, _blocks2.isTemplatePart)(blocks[0]); // Simple block tranformation based on the `Block Transforms` API.
  ...
  var blockSwitcherDescription = 1 === blocks.length ? (0, _i18n.sprintf)(
