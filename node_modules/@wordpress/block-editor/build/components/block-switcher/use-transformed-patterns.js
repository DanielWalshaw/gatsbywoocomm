 ...
 * @return {void}
 */
var transformMatchingBlock = function transformMatchingBlock(match, selectedBlock) {
  // Get the block attributes to retain through the transformation.
  var retainedBlockAttributes = (0, _utils.getRetainedBlockAttributes)(selectedBlock.name, selectedBlock.attributes);
...
var getPatternTransformedBlocks = function getPatternTransformedBlocks(selectedBlocks, patternBlocks) {
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          var match = (0, _utils.getMatchingBlockByName)(patternBlock, selectedBlock.name, consumedBlocks);
          if (!match) continue;
          isMatch = true;
