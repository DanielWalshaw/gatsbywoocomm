...
function WritingFlow(_ref) {
  ...
  function onKeyDown(event) {
    ...
    if (selectedBlockClientId) {
      if (isTab) {
        ...
        if (isFormElement(target) && isFormElement(_dom.focus.tabbable[_direction](target))) {
          return;
        }
  ...
  var lastFocus = (0, _element.useRef)();
  (0, _element.useEffect)(function () {
  ...
  var focusCaptureTabIndex = !isNavigationMode ? '0' : undefined; // Disable reason: Wrapper itself is non-interactive, but must capture
