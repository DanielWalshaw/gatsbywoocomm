...
function useOnBlockDrop(targetRootClientId, targetBlockIndex) {
  ...
  var _onDrop = onBlockDrop(targetRootClientId, targetBlockIndex, getBlockIndex, getClientIdsOfDescendants, moveBlocksToPosition, insertBlocks, clearSelectedBlock);

  var _onFilesDrop = onFilesDrop(targetRootClientId, targetBlockIndex, hasUploadPermissions, updateBlockAttributes, canInsertBlockType, insertBlocks);

  var _onHTMLDrop = onHTMLDrop(targetRootClientId, targetBlockIndex, insertBlocks);
