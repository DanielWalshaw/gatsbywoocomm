...
function useBlockProps() {
  ...
  var mergedRefs = (0, _compose.useMergeRefs)([props.ref, (0, _useFocusFirstElement.useFocusFirstElement)(clientId), // Must happen after focus because we check for focus in the block.
  (0, _useScrollIntoView.useScrollIntoView)(clientId), (0, _useBlockNodes.useBlockNodes)(clientId), (0, _useEventHandlers.useEventHandlers)(clientId), (0, _useNavModeExit.useNavModeExit)(clientId), (0, _useIsHovered.useIsHovered)(), (0, _useMovingAnimation.default)({
