...
function InserterMenu(_ref) {
  ...
  var _useSelect2 = (0, _data.useSelect)(_store.store),
      getBlockOrder = _useSelect2.getBlockOrder,
      getBlockCount = _useSelect2.getBlockCount,
      canInsertBlockType = _useSelect2.canInsertBlockType;

  var _useSelect3 = (0, _data.useSelect)(_blocks.store),
      getBlockType = _useSelect3.getBlockType;
