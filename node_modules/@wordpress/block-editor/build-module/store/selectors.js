...
export var __experimentalGetPatternsByBlockTypes = createSelector(function (state, blockNames) {
  var rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  return _toConsumableArray(__experimentalGetAllowedPatterns.getDependants(state, rootClientId));
});
/**
...
export var __experimentalGetPatternTransformItems = createSelector(function (state, blocks) {
  var rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  return _toConsumableArray(__experimentalGetPatternsByBlockTypes.getDependants(state, rootClientId));
});
/**
