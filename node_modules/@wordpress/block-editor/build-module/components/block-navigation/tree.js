...
export default function BlockNavigationTree(_ref) {
  var __experimentalFeatures = _ref.__experimentalFeatures,
      ...
      props = _objectWithoutProperties(_ref, ["__experimentalFeatures", "__experimentalPersistentListViewFeatures"]);

  var _useBlockNavigationDr = useBlockNavigationDropZone(),
      treeGridRef = _useBlockNavigationDr.ref,
      blockDropTarget = _useBlockNavigationDr.target;
