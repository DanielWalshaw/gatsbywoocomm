...
export var getMatchingBlockByName = function getMatchingBlockByName(block, selectedBlockName) {
...
export var getRetainedBlockAttributes = function getRetainedBlockAttributes(name, attributes) {
  var contentAttributes = getBlockAttributesNamesByRole(name, 'content');
