...
export var BlockSwitcherDropdownMenu = function BlockSwitcherDropdownMenu(_ref) {
  ...
  var _useSelect = useSelect(function (select) {
    var _select = select(blockEditorStore),
        ...
        __experimentalGetPatternTransformItems = _select.__experimentalGetPatternTransformItems;
  ...
  var isReusable = blocks.length === 1 && isReusableBlock(blocks[0]);
  var isTemplate = blocks.length === 1 && isTemplatePart(blocks[0]); // Simple block tranformation based on the `Block Transforms` API.

  var onBlockTransform = function onBlockTransform(name) {
    return replaceBlocks(clientIds, switchToBlockType(blocks, name));
  }; // Pattern transformation through the `Patterns` API.


  var onPatternTransform = function onPatternTransform(transformedBlocks) {
    return replaceBlocks(clientIds, transformedBlocks);
  };

  var hasPossibleBlockTransformations = !!possibleBlockTransformations.length;
  var hasPatternTransformation = !!(patterns !== null && patterns !== void 0 && patterns.length);
  ...
  var blockSwitcherDescription = 1 === blocks.length ? sprintf(
  ...
  var showDropDown = hasBlockStyles || hasPossibleBlockTransformations || hasPatternTransformation;
  return createElement(ToolbarGroup, null, createElement(ToolbarItem, null, function (toggleProps) {
    return createElement(DropdownMenu, {
      ...
      return showDropDown && createElement("div", {
        ...
        blocks: blocks,
        patterns: patterns,
        onSelect: function onSelect(transformedBlocks) {
