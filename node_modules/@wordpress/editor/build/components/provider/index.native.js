...
var NativeEditorProvider = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(NativeEditorProvider, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.updateSettings(_objectSpread(_objectSpread(_objectSpread({}, capabilities), colors ? {
        colors: colors
      } : {}), gradients ? {
        gradients: gradients
      } : {}));
      ...
      this.subscriptionParentShowNotice = (0, _reactNativeBridge.subscribeShowNotice)(function (payload) {
        _this2.props.createSuccessNotice(payload.message);
      });
    }
  }, {
    ...
    value: function toggleMode() {
      var _this$props2 = this.props,
          ...
          switchMode = _this$props2.switchMode; // refresh html content first
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          props = (0, _objectWithoutProperties2.default)(_this$props3, ["children", "post"]);
...
var _default = (0, _compose.compose)([(0, _data.withSelect)(function (select) {
  ...
  var _dispatch5 = dispatch('core/notices'),
      createSuccessNotice = _dispatch5.createSuccessNotice;
