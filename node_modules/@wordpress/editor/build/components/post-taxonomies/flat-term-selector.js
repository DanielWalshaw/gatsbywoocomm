...
var FlatTermSelector = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(FlatTermSelector, [{
    ...
    value: function fetchTerms() {
      ...
      var query = _objectSpread(_objectSpread({}, DEFAULT_QUERY), params);
      ...
      return (0, _apiFetch.default)({
        ...
        if (errorCode === 'term_exists') {
          ...
          _this5.addRequest = (0, _apiFetch.default)({
            path: (0, _url.addQueryArgs)("/wp/v2/".concat(taxonomy.rest_base), _objectSpread(_objectSpread({}, DEFAULT_QUERY), {}, {
