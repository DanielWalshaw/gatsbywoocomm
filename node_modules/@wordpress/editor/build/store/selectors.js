...
var __experimentalGetDefaultTemplatePartAreas = (0, _rememo.default)(function (state) {
  ...
  return areas === null || areas === void 0 ? void 0 : areas.map(function (item) {
    return _objectSpread(_objectSpread({}, item), {}, {
      icon: (0, _getTemplatePartIcon.getTemplatePartIconByArea)(item.area)
    });
  });
}, function (state) {
...
var __experimentalGetDefaultTemplateType = (0, _rememo.default)(function (state, slug) {
  return (0, _lodash.find)(__experimentalGetDefaultTemplateTypes(state), {
    slug: slug
  }) || {};
}, function (state, slug) {
...
function __experimentalGetTemplateInfo(state, template) {
  ...
  var templateTitle = (0, _lodash.isString)(title) ? title : title === null || title === void 0 ? void 0 : title.rendered;
  var templateDescription = (0, _lodash.isString)(excerpt) ? excerpt : excerpt === null || excerpt === void 0 ? void 0 : excerpt.raw;
  var templateIcon = (0, _getTemplatePartIcon.getTemplatePartIconByArea)(area);
  return {
