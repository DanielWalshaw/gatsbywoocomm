    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return _data.controls.select(_constants.STORE_NAME, 'getCurrentPostId');

        case 3:
          postId = _context2.sent;
          _context2.next = 6;
          return _data.controls.dispatch('core', 'receiveAutosaves', postId, newAutosave);
  ...
  return _regenerator.default.wrap(function editPost$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _data.controls.select(_constants.STORE_NAME, 'getCurrentPost');
        ...
        case 2:
          ...
          _context3.next = 7;
          return _data.controls.dispatch('core', 'editEntityRecord', 'postType', type, id, edits, options);
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 3;
          return _data.controls.select(_constants.STORE_NAME, 'isEditedPostSaveable');
        ...
        case 5:
          _context4.next = 7;
          return _data.controls.select(_constants.STORE_NAME, 'getEditedPostContent');
        ...
        case 7:
          ...
          _context4.next = 12;
          return _data.controls.dispatch(_constants.STORE_NAME, 'editPost', edits, {
            undoIgnore: true
          });
        ...
        case 16:
          ...
          _context4.next = 22;
          return _data.controls.select('core', 'getEntityRecordNonTransientEdits', 'postType', previousRecord.type, previousRecord.id);
        ...
        case 22:
          ...
          _context4.next = 28;
          return _data.controls.dispatch('core', 'saveEntityRecord', 'postType', previousRecord.type, edits, options);
        ...
        case 30:
          _context4.next = 32;
          return _data.controls.select('core', 'getLastEntitySaveError', 'postType', previousRecord.type, previousRecord.id);
        ...
        case 32:
          ...
          _context4.next = 38;
          return _data.controls.dispatch.apply(_data.controls, [_notices.store, 'createErrorNotice'].concat((0, _toConsumableArray2.default)(args)));
        ...
        case 42:
          ...
          _context4.next = 48;
          return _data.controls.resolveSelect('core', 'getPostType', updatedRecord.type);
        ...
        case 48:
          ...
          _context4.next = 55;
          return _data.controls.dispatch.apply(_data.controls, [_notices.store, 'createSuccessNotice'].concat((0, _toConsumableArray2.default)(_args4)));
        ...
        case 55:
          ...
          _context4.next = 58;
          return _data.controls.dispatch('core/block-editor', '__unstableMarkLastChangeAsPersistent');
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 2:
          post = _context5.sent;
          _context5.next = 5;
          return _data.controls.select(_constants.STORE_NAME, 'getCurrentPostType');

        case 5:
          postTypeSlug = _context5.sent;
          _context5.next = 8;
          return _data.controls.resolveSelect('core', 'getPostType', postTypeSlug);
        ...
        case 11:
          ...
          _context5.next = 14;
          return _data.controls.dispatch(_constants.STORE_NAME, 'resetPost', newPost);
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          _context6.next = 8;
          return _data.controls.dispatch(_notices.store, 'removeNotice', _constants.TRASH_POST_NOTICE_ID);
        ...
        case 14:
          _context6.next = 16;
          return _data.controls.dispatch(_constants.STORE_NAME, 'savePost');
        ...
        case 18:
          ...
          _context6.next = 22;
          return _data.controls.dispatch.apply(_data.controls, [_notices.store, 'createErrorNotice'].concat((0, _toConsumableArray2.default)((0, _noticeBuilder.getNotificationArgumentsForTrashFail)({
            error: _context6.t0
          }))));
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 4:
          post = _context7.sent;
          _context7.next = 7;
          return _data.controls.select(_constants.STORE_NAME, 'isEditedPostNew');

        case 7:
          isPostNew = _context7.sent;
          _context7.next = 10;
          return _data.controls.select(_constants.STORE_NAME, 'getEditedPostAttribute', 'title');

        case 10:
          title = _context7.sent;
          _context7.next = 13;
          return _data.controls.select(_constants.STORE_NAME, 'getEditedPostAttribute', 'content');

        case 13:
          content = _context7.sent;
          _context7.next = 16;
          return _data.controls.select(_constants.STORE_NAME, 'getEditedPostAttribute', 'excerpt');
        ...
        case 21:
          _context7.next = 23;
          return _data.controls.dispatch(_constants.STORE_NAME, 'savePost', _objectSpread({
            isAutosave: true
          }, options));
  ...
  return _regenerator.default.wrap(function redo$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return _data.controls.dispatch('core', 'redo');
  ...
  return _regenerator.default.wrap(function undo$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          _context9.next = 2;
          return _data.controls.dispatch('core', 'undo');
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 6:
          ...
          _context10.next = 11;
          return _data.controls.select('core', 'getEditedEntityRecord', 'postType', type, id);
        ...
        case 11:
          ...
          _context10.next = 17;
          return _data.controls.dispatch('core', '__unstableCreateUndoLevel', 'postType', type, id);
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            _context11.next = 4;
            return _data.controls.dispatch.apply(_data.controls, ['core/block-editor', name].concat(args));
