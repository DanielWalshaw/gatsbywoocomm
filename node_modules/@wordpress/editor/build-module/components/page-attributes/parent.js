...
function getTitle(post) {
  ...
  return post !== null && post !== void 0 && (_post$title = post.title) !== null && _post$title !== void 0 && _post$title.rendered ? decodeEntities(post.title.rendered) : "#".concat(post.id, " (").concat(__('no title'), ")");
}

export var getItemPriority = function getItemPriority(name, searchValue) {
  var normalizedName = deburr(name).toLowerCase();
  var normalizedSearch = deburr(searchValue).toLowerCase();
