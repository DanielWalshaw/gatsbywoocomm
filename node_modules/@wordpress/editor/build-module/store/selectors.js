 ...
 */
import { find, get, has, isString, pick, mapValues, includes, some } from 'lodash';
import createSelector from 'rememo';
/**
 * WordPress dependencies
 */

import { getFreeformContentHandlerName, getDefaultBlockName, isUnmodifiedDefaultBlock, __unstableSerializeAndClean } from '@wordpress/blocks';
...
export function isEditedPostDateFloating(state) {
  ...
  var modified = getEditedPostAttribute(state, 'modified'); // This should be the status of the persisted post
  // It shouldn't use the "edited" status otherwise it breaks the
  // infered post data floating status
  // See https://github.com/WordPress/gutenberg/issues/28083

  var status = getCurrentPost(state).status;
...
export var __experimentalGetDefaultTemplatePartAreas = createSelector(function (state) {
  var _getEditorSettings2;

  var areas = (_getEditorSettings2 = getEditorSettings(state)) === null || _getEditorSettings2 === void 0 ? void 0 : _getEditorSettings2.defaultTemplatePartAreas;
...
export var __experimentalGetDefaultTemplateType = createSelector(function (state, slug) {
  return find(__experimentalGetDefaultTemplateTypes(state), {
    slug: slug
  }) || {};
}, function (state, slug) {
...
export function __experimentalGetTemplateInfo(state, template) {
  ...
  var templateTitle = isString(title) ? title : title === null || title === void 0 ? void 0 : title.rendered;
  var templateDescription = isString(excerpt) ? excerpt : excerpt === null || excerpt === void 0 ? void 0 : excerpt.raw;
