...
function getBlockTransforms(direction, blockTypeOrName) {
  ...
  var filteredTransforms = usingMobileTransformations ? (0, _lodash.filter)(transforms[direction], function (t) {
    if (t.type === 'raw') {
      return true;
    }
    ...
    return (0, _lodash.every)(t.blocks, function (transformBlockName) {
