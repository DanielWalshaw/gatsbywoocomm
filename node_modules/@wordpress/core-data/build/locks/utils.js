...
var _marked = /*#__PURE__*/_regeneratorRuntime2.mark(iteratePath),
    _marked2 = /*#__PURE__*/_regeneratorRuntime2.mark(iterateDescendants);
...
function deepCopyLocksTreePath(tree, path) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      currentNode.children = _objectSpread(_objectSpread({}, currentNode.children), {}, (0, _defineProperty2.default)({}, branchName, _objectSpread({
        locks: [],
        children: {}
...
function iteratePath(tree, path) {
  ...
  return _regenerator.default.wrap(function iteratePath$(_context) {
    while (1) {
...
function iterateDescendants(node) {
  var stack, childNode;
  return _regenerator.default.wrap(function iterateDescendants$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 5:
          stack.push.apply(stack, (0, _toConsumableArray2.default)(Object.values(childNode.children)));
          _context2.next = 1;
          break;
