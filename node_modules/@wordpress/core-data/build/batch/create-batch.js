...
function createBatch() {
  var processor = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _defaultProcessor.default;
  var lastId = 0;
  var queue = [];
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 16:
                isSuccess = true;
                _iterator2 = _createForOfIteratorHelper((0, _lodash.zip)(results, queue));

                try {
                  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                    _step2$value = (0, _slicedToArray2.default)(_step2.value, 2), result = _step2$value[0], _step2$value$ = _step2$value[1], resolve = _step2$value$.resolve, _reject = _step2$value$.reject;
...
var ObservableSet = /*#__PURE__*/function () {
  function ObservableSet() {
    ...
    this.set = (0, _construct2.default)(Set, args);
