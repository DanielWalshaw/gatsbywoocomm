...
var isRequestingEmbedPreview = (0, _data.createRegistrySelector)(function (select) {
  return function (state, url) {
    return select('core/data').isResolving(_name.STORE_NAME, 'getEmbedPreview', [url]);
  };
});
/**
...
function getAuthors(state, query) {
  var path = (0, _url.addQueryArgs)('/wp/v2/users/?who=authors&per_page=100', query);
...
function __unstableGetAuthor(state, id) {
  return (0, _lodash.get)(state, ['users', 'byId', id], null);
}
/**
