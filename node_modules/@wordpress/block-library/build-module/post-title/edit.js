...
export default function PostTitleEdit(_ref) {
  ...
  var _post$title = post.title,
      ...
      link = post.link;
  var titleElement = createElement(TagName, isLink ? {} : blockProps, __('An example title'));

  if (postType && postId) {
    titleElement = createElement(PlainText, _extends({
      tagName: TagName,
  ...
  if (isLink) {
    titleElement = createElement(TagName, blockProps, createElement(PlainText, {
      tagName: "a",
      href: link,
      target: linkTarget,
      rel: rel,
