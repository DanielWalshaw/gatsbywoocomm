...
import { BlockContextProvider, BlockPreview, useBlockProps, __experimentalUseInnerBlocksProps as useInnerBlocksProps, store as blockEditorStore } from '@wordpress/block-editor';
...
export default function QueryLoopEdit(_ref) {
  ...
  var perPage = _ref$context$query.perPage,
      ...
      queryContext = _ref$context$queryCon === void 0 ? [{
    page: 1
  }] : _ref$context$queryCon,
  ...
  var _queryContext = _slicedToArray(queryContext, 1),
  ...
  return createElement("ul", blockProps, blockContexts && blockContexts.map(function (blockContext) {
    return createElement(BlockContextProvider, {
      key: blockContext.postId,
      value: blockContext
    }, blockContext === (activeBlockContext || blockContexts[0]) ? createElement("li", innerBlocksProps) : createElement("li", null, createElement(BlockPreview, {
      blocks: blocks,
