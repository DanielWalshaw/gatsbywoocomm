...
export var pickRelevantMediaFiles = function pickRelevantMediaFiles(image, size) {
...
export function ImageEdit(_ref) {
  ...
  var _useState = useState(),
      ...
      temporaryURL = _useState2[0],
      setTemporaryURL = _useState2[1];
  ...
  var _useSelect = useSelect(function (select) {
    ...
    return pick(getSettings(), ['imageDefaultSize', 'mediaUpload']);
      ...
      imageDefaultSize = _useSelect.imageDefaultSize,
  ...
  function onSelectImage(media) {
    ...
    setTemporaryURL();
    var mediaAttributes = pickRelevantMediaFiles(media, imageDefaultSize); // If a caption text was meanwhile written by the user,
