...
export default function Image(_ref) {
  ...
  var coverBlockExists = !!getBlockType('core/cover');
  useEffect(function () {
    if (!isSelected) {
  ...
  }), !multiImageSelection && coverBlockExists && createElement(ToolbarButton, {
    icon: overlayText,
    label: __('Add text over image'),
    onClick: function onClick() {
      return replaceBlocks(currentId, switchToBlockType(block, 'core/cover'));
    }
