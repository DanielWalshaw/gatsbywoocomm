...
import { CycleSelectControl, Icon, PanelBody, ToolbarButton, ToolbarGroup, Image, WIDE_ALIGNMENTS, LinkSettingsNavigation, BottomSheetTextControl, FooterMessageLink, Badge } from '@wordpress/components';
...
import { image as placeholderIcon, replace, expand, textColor } from '@wordpress/icons';
...
export var ImageEdit = /*#__PURE__*/function (_Component) {
  ...
  function ImageEdit(props) {
    ...
    _this.setMappedAttributes = _this.setMappedAttributes.bind(_assertThisInitialized(_this));
    _this.onSizeChangeValue = _this.onSizeChangeValue.bind(_assertThisInitialized(_this));
    ...
    _this.sizeOptions = map(_this.props.imageSizes, function (_ref2) {
      var name = _ref2.name,
          slug = _ref2.slug;
      return {
        value: slug,
  ...
  _createClass(ImageEdit, [{
    ...
    value: function onSelectMediaUploadOption(media) {
      var _this$props4 = this.props,
          ...
          id = _this$props4$attribut.id,
          url = _this$props4$attribut.url,
          imageDefaultSize = _this$props4.imageDefaultSize;
      var mediaAttributes = {
        id: media.id,
        url: media.url,
    ...
    key: "setMappedAttributes",
    value: function setMappedAttributes(_ref3) {
      var href = _ref3.url,
          restAttributes = _objectWithoutProperties(_ref3, ["url"]);
    ...
    value: function getLinkSettings() {
      ...
      var _this$props$attribute = this.props.attributes,
          url = _this$props$attribute.href,
          unMappedAttributes = _objectWithoutProperties(_this$props$attribute, ["href"]);
    ...
    key: "getAltTextSettings",
    value: function getAltTextSettings() {
      var _this2 = this;

      var alt = this.props.attributes.alt;

      var updateAlt = function updateAlt(newAlt) {
    ...
    key: "onSizeChangeValue",
    value: function onSizeChangeValue(newValue) {
    ...
    value: function render() {
      ...
      var _this$props5 = this.props,
          ...
          imageDefaultSize = _this$props5.imageDefaultSize,
          featuredImageId = _this$props5.featuredImageId,
          wasBlockJustInserted = _this$props5.wasBlockJustInserted;
      var align = attributes.align,
          url = attributes.url,
          alt = attributes.alt,
          id = attributes.id,
      ...
      var sizeOptionsValid = find(this.sizeOptions, ['value', imageDefaultSize]);
      var isFeaturedImage = featuredImageId === attributes.id;
      ...
      var getToolbarEditButton = function getToolbarEditButton(open) {
        return createElement(BlockControls, null, createElement(ToolbarGroup, null, createElement(ToolbarButton, {
          ...
          value: align,
          onChange: _this3.updateAlignment
        }));
      };
      ...
      var getInspectorControls = function getInspectorControls() {
        return createElement(InspectorControls, null, createElement(PanelBody, {
          ...
          onChangeValue: _this3.onSizeChangeValue,
          options: _this3.sizeOptions
        }), _this3.getAltTextSettings()), createElement(PanelBody, {
          title: __('Link Settings')
        }, _this3.getLinkSettings(true)));
      };
      ...
      if (!url) {
        return createElement(View, {
          ...
          autoOpenMediaUpload: isSelected && !url && wasBlockJustInserted
        }));
      }
      ...
      var getImageComponent = function getImageComponent(openMediaOptions, getMediaOptions) {
        return createElement(Badge, {
          ...
          onPress: _this3.onImagePressed,
          onLongPress: openMediaOptions,
          disabled: !isSelected
        }, createElement(View, {
          style: styles.content
        }, isSelected && getInspectorControls(), isSelected && getMediaOptions(), !_this3.state.isCaptionSelected && getToolbarEditButton(openMediaOptions), createElement(MediaUploadProgress, {
          coverUrl: url,
          mediaId: id,
          onUpdateMediaProgress: _this3.updateMediaProgress,
          onFinishMediaUploadWithSuccess: _this3.finishMediaUploadWithSuccess,
          onFinishMediaUploadWithFailure: _this3.finishMediaUploadWithFailure,
          onMediaUploadStateReset: _this3.mediaUploadStateReset,
          renderContent: function renderContent(_ref4) {
            ...
            return createElement(Image, {
              ...
              onSelectMediaUploadOption: _this3.onSelectMediaUploadOption,
          ...
          isSelected: _this3.state.isCaptionSelected,
          accessible: true,
          accessibilityLabelCreator: _this3.accessibilityLabelCreator,
          onFocus: _this3.onFocusCaption,
          onBlur: _this3.props.onBlur // always assign onBlur as props
          ,
          insertBlocksAfter: _this3.props.insertBlocksAfter
        }));
      };
...
export default compose([withSelect(function (select, props) {
  ...
  var _select2 = select(blockEditorStore),
      ...
      wasBlockJustInserted = _select2.wasBlockJustInserted;
  ...
  var _getSettings = getSettings(),
      ...
      imageDefaultSize = _getSettings.imageDefaultSize;
