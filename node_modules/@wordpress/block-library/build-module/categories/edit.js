...
export default function CategoriesEdit(_ref) {
  ...
  return createElement("div", useBlockProps(), createElement(InspectorControls, null, createElement(PanelBody, {
    ...
    icon: pin,
    label: __('Categories')
  }, createElement(Spinner, null)), !isRequesting && categories.length === 0 && createElement("p", null, __('Your site does not have any posts, so there is nothing to display here at the moment.')), !isRequesting && categories.length > 0 && (displayAsDropdown ? renderCategoryDropdown() : renderCategoryList()));
}
