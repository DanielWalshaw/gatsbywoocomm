...
import { Notice, PanelBody, RangeControl, ResizableBox, Spinner } from '@wordpress/components';
...
var SiteLogo = function SiteLogo(_ref) {
  ...
  var _useSelect = useSelect(function (select) {
    ...
    var siteEntities = select(coreStore).getEditedEntityRecord('root', 'site');
  ...
  var maxWidthBuffer = maxWidth * 2.5; // Set the default width to a responsible size.
...
export default function LogoEdit(_ref2) {
  ...
  var _useSelect2 = useSelect(function (select) {
    var siteSettings = select(coreStore).getEditedEntityRecord('root', 'site');
    var mediaItem = select(coreStore).getEntityRecord('root', 'media', siteSettings.sitelogo);
    return {
  ...
  var _useDispatch2 = useDispatch(coreStore),
  ...
  var controls = logoUrl && createElement(BlockControls, {
    group: "other"
