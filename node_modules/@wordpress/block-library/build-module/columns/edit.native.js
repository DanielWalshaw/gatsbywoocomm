...
import { InspectorControls, InnerBlocks, BlockControls, BlockVerticalAlignmentToolbar, BlockVariationPicker, store as blockEditorStore } from '@wordpress/block-editor';
...
function ColumnsEditContainer(_ref) {
  ...
  var contentWidths = useMemo(function () {
    return getContentWidths(columnsInRow, width, columnCount, innerWidths, globalStyles);
  ...
  var onChangeUnit = function onChangeUnit(nextUnit, index, columnId) {
    var widthWithoutUnit = parseFloat(getWidths(innerWidths)[index]);
  ...
  var getColumnsSliders = useMemo(function () {
    ...
    return innerWidths.map(function (column, index) {
      ...
      return createElement(UnitControl, {
        ...
        settingLabel: "Width",
        key: "".concat(column.clientId, "-").concat(getWidths(innerWidths).length),
        min: 1,
  ...
  var onChangeColumnsNum = useCallback(function (value) {
...
var ColumnsEditContainerWrapper = withDispatch(function (dispatch, ownProps, registry) {
  return {
    ...
    updateInnerColumnWidth: function updateInnerColumnWidth(value, columnId) {
      var _dispatch2 = dispatch(blockEditorStore),
    ...
    updateBlockSettings: function updateBlockSettings(settings) {
      ...
      var _dispatch3 = dispatch(blockEditorStore),
    ...
    updateColumns: function updateColumns(previousColumns, newColumns) {
      ...
      var _dispatch4 = dispatch(blockEditorStore),
    ...
    onAddNextColumn: function onAddNextColumn() {
      ...
      var _dispatch5 = dispatch(blockEditorStore),
          replaceInnerBlocks = _dispatch5.replaceInnerBlocks,
          selectBlock = _dispatch5.selectBlock;

      var _registry$select3 = registry.select(blockEditorStore),
    ...
    onDeleteBlock: function onDeleteBlock() {
      ...
      var _dispatch6 = dispatch(blockEditorStore),
...
var ColumnsEdit = function ColumnsEdit(props) {
  ...
  var memoizedInnerWidths = useMemo(function () {
    return innerWidths;
