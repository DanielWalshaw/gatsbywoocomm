...
import { ToolbarGroup, ToolbarButton, ToggleControl, Popover, DateTimePicker, PanelBody, CustomSelectControl } from '@wordpress/components';
...
export default function PostDateEdit(_ref) {
  ...
  var postDate = date ? createElement("time", {
