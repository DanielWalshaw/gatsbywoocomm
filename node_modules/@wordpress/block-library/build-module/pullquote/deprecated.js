...
import { getColorClassName, getColorObjectByAttributeValues, RichText, store as blockEditorStore } from '@wordpress/block-editor';
...
var deprecated = [{
  ...
  save: function save(_ref3) {
    ...
    if (isSolidColorStyle) {
      ...
      var colors = get(select(blockEditorStore).getSettings(), ['colors'], []);
