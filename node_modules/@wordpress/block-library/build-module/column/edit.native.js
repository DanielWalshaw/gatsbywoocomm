...
import { InnerBlocks, BlockControls, BlockVerticalAlignmentToolbar, InspectorControls, store as blockEditorStore } from '@wordpress/block-editor';
...
function ColumnEdit(_ref) {
  ...
  if (!contentStyle) {
    contentStyle = _defineProperty({}, clientId, {});
  }
  ...
  var renderAppender = useCallback(function () {
    var columnWidth = contentStyle[clientId].width;
    var isScreenWidthEqual = columnWidth === screenWidth;
