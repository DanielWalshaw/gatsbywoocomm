...
export var UnsupportedBlockEdit = /*#__PURE__*/function (_Component) {
  ...
  function UnsupportedBlockEdit(props) {
    ...
    _this.closeSheet = _this.closeSheet.bind(_assertThisInitialized(_this));
    _this.requestFallback = _this.requestFallback.bind(_assertThisInitialized(_this));
    _this.onHelpButtonPressed = _this.onHelpButtonPressed.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(UnsupportedBlockEdit, [{
    ...
    value: function renderSheet(blockTitle, blockName) {
      ...
      var missingBlockDetail = applyFilters('native.missing_block_detail', __('We are working hard to add more blocks with each release.'));
      var missingBlockActionButton = applyFilters('native.missing_block_action_button', __('Edit using web editor'));
