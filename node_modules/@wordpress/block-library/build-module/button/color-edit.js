...
import { useState, useEffect, useRef, useMemo, Platform } from '@wordpress/element';
/**
...
function ColorEdit(props) {
  var _style$color4, _style$color5, _style$color6;
  ...
  var settings = useMemo(function () {
    ...
    return [{
      ...
      colorValue: getColorObjectByAttributeValues(colors, textColor, style === null || style === void 0 ? void 0 : (_style$color2 = style.color) === null || _style$color2 === void 0 ? void 0 : _style$color2.text).color
    }, {
      label: __('Background color'),
      onColorChange: onChangeColor('background'),
      colorValue: getColorObjectByAttributeValues(colors, backgroundColor, style === null || style === void 0 ? void 0 : (_style$color3 = style.color) === null || _style$color3 === void 0 ? void 0 : _style$color3.background).color,
      gradientValue: gradientValue,
      onGradientChange: onChangeGradient
    }];
  }, [colors, textColor, backgroundColor, gradientValue, style === null || style === void 0 ? void 0 : (_style$color4 = style.color) === null || _style$color4 === void 0 ? void 0 : _style$color4.text, style === null || style === void 0 ? void 0 : (_style$color5 = style.color) === null || _style$color5 === void 0 ? void 0 : _style$color5.background]);
  return createElement(ColorPanel, {
    enableContrastChecking: !gradient && !(style !== null && style !== void 0 && (_style$color6 = style.color) !== null && _style$color6 !== void 0 && _style$color6.gradient),
