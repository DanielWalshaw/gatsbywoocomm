...
function TemplatePartPreviews(_ref6) {
  ...
  var templateParts = (0, _data.useSelect)(function (select) {
    return select(_coreData.store).getEntityRecords('postType', 'wp_template_part') || [];
  }, []);
