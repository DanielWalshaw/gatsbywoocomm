...
var UBE_INCOMPATIBLE_BLOCKS = ['core/block'];
...
var UnsupportedBlockEdit = /*#__PURE__*/function (_Component) {
  ...
  function UnsupportedBlockEdit(props) {
    ...
    _this.closeSheet = _this.closeSheet.bind((0, _assertThisInitialized2.default)(_this));
    _this.requestFallback = _this.requestFallback.bind((0, _assertThisInitialized2.default)(_this));
    _this.onHelpButtonPressed = _this.onHelpButtonPressed.bind((0, _assertThisInitialized2.default)(_this));
    return _this;
  }
  ...
  (0, _createClass2.default)(UnsupportedBlockEdit, [{
    ...
    key: "onHelpButtonPressed",
    value: function onHelpButtonPressed() {
    ...
    value: function renderSheet(blockTitle, blockName) {
      ...
      var _this$props = this.props,
          ...
          isEditableInUnsupportedBlockEditor = _this$props.isEditableInUnsupportedBlockEditor;
      ...
      var missingBlockDetail = (0, _hooks.applyFilters)('native.missing_block_detail', (0, _i18n.__)('We are working hard to add more blocks with each release.'));
      var missingBlockActionButton = (0, _hooks.applyFilters)('native.missing_block_action_button', (0, _i18n.__)('Edit using web editor'));
...
var _default = (0, _compose.compose)([(0, _data.withSelect)(function (select, _ref) {
  ...
  var _dispatch = dispatch(_blockEditor.store),
      _selectBlock = _dispatch.selectBlock;

  return {
    selectBlock: function selectBlock() {
      _selectBlock(ownProps.clientId);
    }
  };
