...
function ColorEdit(props) {
  ...
  var settings = (0, _element.useMemo)(function () {
    ...
    return [{
      ...
      colorValue: (0, _blockEditor.getColorObjectByAttributeValues)(colors, textColor, style === null || style === void 0 ? void 0 : (_style$color2 = style.color) === null || _style$color2 === void 0 ? void 0 : _style$color2.text).color
    }, {
      label: (0, _i18n.__)('Background color'),
      onColorChange: onChangeColor('background'),
      colorValue: (0, _blockEditor.getColorObjectByAttributeValues)(colors, backgroundColor, style === null || style === void 0 ? void 0 : (_style$color3 = style.color) === null || _style$color3 === void 0 ? void 0 : _style$color3.background).color,
