...
function Image(_ref) {
  var temporaryURL = _ref.temporaryURL,
  ...
  var _useSelect = (0, _data.useSelect)(function (select) {
    ...
    return {
      ...
      currentId = _useSelect.currentId,
  ...
  var _useSelect2 = (0, _data.useSelect)(function (select) {
    var _select3 = select(_blockEditor.store),
  ...
  var coverBlockExists = !!(0, _blocks.getBlockType)('core/cover');
  ...
  }), !multiImageSelection && coverBlockExists && (0, _element.createElement)(_components.ToolbarButton, {
    icon: _icons.overlayText,
    label: (0, _i18n.__)('Add text over image'),
    onClick: function onClick() {
      return replaceBlocks(currentId, (0, _blocks.switchToBlockType)(block, 'core/cover'));
    }
