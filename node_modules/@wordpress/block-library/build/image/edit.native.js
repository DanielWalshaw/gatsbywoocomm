...
var ImageEdit = /*#__PURE__*/function (_Component) {
  ...
  function ImageEdit(props) {
    ...
    _this.setMappedAttributes = _this.setMappedAttributes.bind((0, _assertThisInitialized2.default)(_this));
    _this.onSizeChangeValue = _this.onSizeChangeValue.bind((0, _assertThisInitialized2.default)(_this));
    ...
    _this.sizeOptions = (0, _lodash.map)(_this.props.imageSizes, function (_ref2) {
      var name = _ref2.name,
          slug = _ref2.slug;
      return {
        value: slug,
  ...
  (0, _createClass2.default)(ImageEdit, [{
    ...
    value: function setMappedAttributes(_ref3) {
      var href = _ref3.url,
          restAttributes = (0, _objectWithoutProperties2.default)(_ref3, ["url"]);
      var setAttributes = this.props.setAttributes;
    ...
    value: function getLinkSettings() {
      ...
      var _this$props$attribute = this.props.attributes,
          ...
          unMappedAttributes = (0, _objectWithoutProperties2.default)(_this$props$attribute, ["href"]);
    ...
    value: function render() {
      ...
      var sizeOptionsValid = (0, _lodash.find)(this.sizeOptions, ['value', imageDefaultSize]);
      ...
      var getInspectorControls = function getInspectorControls() {
        ...
        }), _this3.getAltTextSettings()), (0, _element.createElement)(_components.PanelBody, {
      ...
      var getImageComponent = function getImageComponent(openMediaOptions, getMediaOptions) {
        return (0, _element.createElement)(_components.Badge, {
          ...
          style: _styles.default.content
        }, isSelected && getInspectorControls(), isSelected && getMediaOptions(), !_this3.state.isCaptionSelected && getToolbarEditButton(openMediaOptions), (0, _element.createElement)(_blockEditor.MediaUploadProgress, {
          coverUrl: url,
          mediaId: id,
