...
function PostTitleEdit(_ref) {
  ...
  if (isLink) {
    titleElement = (0, _element.createElement)(TagName, blockProps, (0, _element.createElement)(_blockEditor.PlainText, {
      tagName: "a",
      href: link,
      target: linkTarget,
      rel: rel,
      placeholder: title.length === 0 ? (0, _i18n.__)('No Title') : null,
      value: title,
      onChange: function onChange(value) {
        return editEntityRecord('postType', postType, postId, {
          title: value
