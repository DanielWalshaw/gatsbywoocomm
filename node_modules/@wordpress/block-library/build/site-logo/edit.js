...
var SiteLogo = function SiteLogo(_ref) {
  ...
  var _useSelect = (0, _data.useSelect)(function (select) {
    ...
    var siteEntities = select(_coreData.store).getEditedEntityRecord('root', 'site');
...
function LogoEdit(_ref2) {
  ...
  var _useSelect2 = (0, _data.useSelect)(function (select) {
    var siteSettings = select(_coreData.store).getEditedEntityRecord('root', 'site');
    var mediaItem = select(_coreData.store).getEntityRecord('root', 'media', siteSettings.sitelogo);
    return {
  ...
  var _useDispatch2 = (0, _data.useDispatch)(_coreData.store),
  ...
  var controls = logoUrl && (0, _element.createElement)(_blockEditor.BlockControls, {
    group: "other"
