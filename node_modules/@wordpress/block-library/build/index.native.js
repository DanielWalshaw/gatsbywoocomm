...
var _transformationCategories = require("./transformationCategories");
...
shortcode, archives, audio, button, calendar, categories, code, columns, column, cover, embed, file, html, mediaText, latestComments, latestPosts, missing, more, nextpage, preformatted, pullquote, rss, search, separator, reusableBlock, spacer, table, tagCloud, textColumns, verse, video, classic, buttons, socialLink, socialLinks].reduce(function (accumulator, block) {
...
(0, _hooks.addFilter)('blocks.registerBlockType', 'core/react-native-editor', function (settings, name) {
  ...
  if (!settings.transforms.supportedMobileTransforms) {
    return _objectSpread(_objectSpread({}, settings), {}, {
      transforms: _objectSpread(_objectSpread({}, settings.transforms), {}, {
...
var registerCoreBlocks = function registerCoreBlocks() {
  ...
  [paragraph, heading, devOnly(code), missing, more, image, video, nextpage, separator, list, quote, mediaText, preformatted, gallery, columns, column, group, classic, button, spacer, shortcode, buttons, latestPosts, verse, cover, socialLink, socialLinks, pullquote, file, audio, devOnly(reusableBlock), devOnly(search), devOnly(embed)].forEach(registerBlock);
