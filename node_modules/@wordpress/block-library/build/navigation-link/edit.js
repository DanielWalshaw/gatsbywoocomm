...
function NavigationLinkEdit(_ref) {
  ...
  var blockProps = (0, _blockEditor.useBlockProps)({
    ...
    }, (0, _defineProperty2.default)(_classnames, "has-".concat(textColor, "-color"), !!textColor), (0, _defineProperty2.default)(_classnames, 'has-background', !!backgroundColor || !!(style !== null && style !== void 0 && (_style$color2 = style.color) !== null && _style$color2 !== void 0 && _style$color2.background)), (0, _defineProperty2.default)(_classnames, "has-".concat(backgroundColor, "-background-color"), !!backgroundColor), _classnames)),
    style: {
  ...
  var innerBlocksProps = (0, _blockEditor.__experimentalUseInnerBlocksProps)({
    className: (0, _classnames2.default)('wp-block-navigation-link__container', {
  ...
  var classes = (0, _classnames2.default)('wp-block-navigation-link__content', {
  ...
  switch (type) {
    case 'post':
      ...
      missingText = (0, _i18n.__)('Select a post');
      break;

    case 'page':
      /* translators: label for missing page in navigation link block */
      missingText = (0, _i18n.__)('Select a page');
      break;

    case 'category':
      /* translators: label for missing category in navigation link block */
      missingText = (0, _i18n.__)('Select a category');
      break;

    case 'tag':
      /* translators: label for missing tag in navigation link block */
      missingText = (0, _i18n.__)('Select a tag');
      break;

    default:
      /* translators: label for missing values in navigation link block */
      missingText = (0, _i18n.__)('Add a link');
  }
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.BlockControls, null, (0, _element.createElement)(_components.ToolbarGroup, null, (0, _element.createElement)(_components.KeyboardShortcuts, {
    ...
    autoComplete: "off"
  }))), (0, _element.createElement)("li", blockProps, (0, _element.createElement)("a", {
    className: classes
